...
void CalculatorOutputWriter::writeRequest(std::unique_ptr<CalculatorRequest>& calculatorRequest)
{
    ...
    QString logMessage("<span style='color: blue;'>Отправили запрос с ID: %1<br>"
                                                  "Выражение: %2</span>");
...
void CalculatorOutputWriter::writeResponse(std::unique_ptr<CalculatorResponse>& calculatorResponse)
{
    ...
    {
        QString logMessage("<span style='color: yellow;'>Приняли ответ с ID: %1<br>"
                                                      "Ошибка: %2</span><br><br>");
    ...
    {
        QString logMessage("<span style='color: green;'>Приняли ответ с ID: %1<br>"
                                                      "Результат: %2</span><br><br>");
